...
class KirimWa implements ShouldQueue
{
    ...
    public function handle(): void
    {
        ...
        if ($this->broadcast->image != null) {
            $reqPayload['image'] = "https://broadcast-api.zainzo.com/storage/bc_images/" . $this->broadcast->image;
        }

        Http::post('https://whatsapp.zainzo.com/send-message', $reqPayload);
